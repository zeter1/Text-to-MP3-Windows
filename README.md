...
Готовая Windows-сборка с **`Text-to-MP3-Windows.exe`** публикуется на странице [GitHub Releases](https://github.com/zeter1/Text-to-MP3-Windows/releases) в portable-архиве `Text-to-MP3-Windows-x64.zip`.
